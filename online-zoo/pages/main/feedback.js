const feedback = [
    ...
    {
        'name': 'Oska Samborska ',
        'icon': '../../assets/images/user4.png',
        'date': 'Local Austria • Friday',
