...
function burgerOpen() {
    document.querySelector('.donate').classList.remove('link-off')
    document.querySelector('.donate > a').style.color = 'black'
...
function burgerClose() {
    document.querySelector('.donate').classList.add('link-off')
